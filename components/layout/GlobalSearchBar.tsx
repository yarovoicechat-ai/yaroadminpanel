    ...
    return (
        <div className="relative w-full max-w-md">
            ...
            >
                ...
                <span className="flex-1 truncate">Search by Employee Code, Role Code, Meethi ID, Email...</span>
                ...
                <div className="absolute top-12 left-0 right-0 z-50 bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl p-3 space-y-2 max-h-96 overflow-y-auto">
                    <div className="flex items-center gap-2 border-b border-slate-800 pb-2">
                        ...
                        <input
                            ...
                            placeholder="Search by Employee Code, Role Code, Meethi ID, Mobile, Name..."
