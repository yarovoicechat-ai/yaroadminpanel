...
const STORAGE_KEY = "yaro_admin_theme_v2"
const DEFAULTS: Settings = { accent: "#e11d48", font: "modern", radius: 14, density: "comfortable", depth: "soft", canvas: "white" }
const PALETTES = [["Rose", "#e11d48"], ["Violet", "#7c3aed"], ["Teal", "#0f9f8f"], ["Orange", "#ea580c"]] as const
            ...
            <header className="theme-studio-hero relative overflow-hidden border-b border-border px-6 py-6">
                ...
                <div className="relative flex items-start justify-between gap-4">
                    <div className="flex items-center gap-3">
                        ...
                        <div><p className="text-[10px] font-bold uppercase tracking-[.22em] text-primary">Admin appearance</p><h2 id="theme-studio-title" className="text-xl font-bold text-foreground">Theme Studio</h2></div>
                    </div>
