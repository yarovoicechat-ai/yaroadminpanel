...
"[project]/admin/app/apply/agency/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AgencyFormContent() {
    ...
    const validateCurrentStep = ()=>{
        if (currentStep === 0) {
            if (!formData.businessName.trim() || !formData.businessAddress.trim() || !formData.city.trim()) {
                __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('Please enter Business Name, City, and Address.');
                return false;
            }
        } else if (currentStep === 1) {
            if (!formData.managerName.trim() || !formData.email.trim() || !formData.phone.trim()) {
                __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('Manager Name, Email, and Phone Number are required.');
                return false;
            }
            ...
            if (!formData.payoutUpiOrBank.trim()) {
                __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('Please specify your Payout UPI ID or Bank Details.');
                return false;
            }
        }
        return true;
    ...
    const handleSubmit = async ()=>{
        ...
        if (!formData.agreedToTerms) {
            __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('You must accept the terms and agency policies to submit.');
            return;
        }
        try {
            setSubmitting(true);
            ...
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$lib$2f$apiClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].post('/api/recruitment/agency', payload);
            if (res.success && res.data) {
                setApplicationId(res.data.applicationId);
                setSuccess(true);
                __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success('Agency Onboarding Application Submitted!');
                localStorage.removeItem('recruitment_draft_agency');
            } else {
                __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error(res.message || 'Submission failed. Please check your data.');
            }
        } catch (error) {
...
function AgencyApplyPage() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Suspense"], {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(AgencyFormContent, {}, void 0, false, {
            fileName: "[project]/admin/app/apply/agency/page.tsx",
            lineNumber: 457,
            columnNumber: 13
        }, this)
...
//# sourceMappingURL=admin_c757163b._.js.map