...
"[project]/admin/app/apply/customer-service/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CustomerServiceFormContent() {
    ...
    const validateCurrentStep = ()=>{
        if (currentStep === 0) {
            if (!formData.fullName.trim() || !formData.email.trim() || !formData.phone.trim()) {
                __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('Full Name, Email, and Phone Number are required.');
                return false;
            }
            ...
            if (!formData.userConflictScenarioAnswer.trim() || formData.userConflictScenarioAnswer.length < 15) {
                __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('Please answer how you handle upset users (minimum 15 characters).');
                return false;
            }
        }
        return true;
    ...
    const handleSubmit = async ()=>{
        ...
        if (!formData.agreedToTerms) {
            __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error('Please accept the customer service pledge to submit.');
            return;
        }
        try {
            setSubmitting(true);
            ...
            const res = await __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$lib$2f$apiClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["apiClient"].post('/api/recruitment/customer-service', payload);
            if (res.success && res.data) {
                setApplicationId(res.data.applicationId);
                setSuccess(true);
                __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success('Customer Support Application Submitted!');
...
function CustomerServiceApplyPage() {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Suspense"], {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(CustomerServiceFormContent, {}, void 0, false, {
            fileName: "[project]/admin/app/apply/customer-service/page.tsx",
            lineNumber: 444,
            columnNumber: 13
        }, this)
...
//# sourceMappingURL=admin_c121c25f._.js.map