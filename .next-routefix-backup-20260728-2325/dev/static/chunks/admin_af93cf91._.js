...
"[project]/admin/app/(dashboard)/admins/request/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function AdminRequestsPage() {
    ...
    const fetchRequests = (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AdminRequestsPage.useCallback[fetchRequests]": async ()=>{
            setLoading(true);
            try {
                ...
                if (res && res.success !== false) {
                    const apiData = items.map({
                        "AdminRequestsPage.useCallback[fetchRequests].apiData": (item, idx)=>{
                            const d = item.data || {};
                            const opRev = item.approvedBy?.find({
                                "AdminRequestsPage.useCallback[fetchRequests].apiData": (a)=>a.role === 'operator'
                            }["AdminRequestsPage.useCallback[fetchRequests].apiData"]) || item.reviewByOperator || {};
                            const saRev = item.approvedBy?.find({
                                "AdminRequestsPage.useCallback[fetchRequests].apiData": (a)=>a.role === 'superAdmin' || a.role === 'super_admin'
                            }["AdminRequestsPage.useCallback[fetchRequests].apiData"]) || item.reviewBySuperAdmin || {};
                    ...
                    }["AdminRequestsPage.useCallback[fetchRequests].apiData"]);
                    setRequests(apiData);
                } else {
                    setRequests([]);
                }
    ...
    }["AdminRequestsPage.useCallback[fetchRequests]"], []);
    ...
    const filteredRequests = (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminRequestsPage.useMemo[filteredRequests]": ()=>{
            return requests.filter({
                "AdminRequestsPage.useMemo[filteredRequests]": (req)=>{
                    // Search Query Filter
    ...
    const sortedRequests = (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminRequestsPage.useMemo[sortedRequests]": ()=>{
            return [
                ...filteredRequests
            ].sort({
                "AdminRequestsPage.useMemo[sortedRequests]": (a, b)=>{
    ...
    const paginatedRequests = (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminRequestsPage.useMemo[paginatedRequests]": ()=>{
    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AdminRequestsPage.useMemo[stats]": ()=>{
            return {
                total: requests.length,
                active: requests.filter({
                    "AdminRequestsPage.useMemo[stats]": (r)=>r.status === 'active'
                }["AdminRequestsPage.useMemo[stats]"]).length,
                pending: requests.filter({
                    "AdminRequestsPage.useMemo[stats]": (r)=>r.status === 'pending'
                }["AdminRequestsPage.useMemo[stats]"]).length,
                readyForInterview: requests.filter({
                    "AdminRequestsPage.useMemo[stats]": (r)=>r.status === 'ready_for_interview'
                }["AdminRequestsPage.useMemo[stats]"]).length,
                rejected: requests.filter({
                    "AdminRequestsPage.useMemo[stats]": (r)=>r.status === 'rejected'
                }["AdminRequestsPage.useMemo[stats]"]).length
            };
        }
    }["AdminRequestsPage.useMemo[stats]"], [
    ...
    const submitAction = async ()=>{
        ...
        try {
            ...
            if (response.success) {
                ...
                if (!isAccept || !response.data?.generatedCredentials) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(isAccept ? `✅ Admin request for ${req.name} APPROVED!` : `❌ Request for ${req.name} REJECTED.`);
                }
                setConfirmModal({
                    isOpen: false,
                    type: 'accept',
                                            ...
                                            children: [
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                children: [
                                                                    ...
                                                                    req.adminCode && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        }, void 0, true) : /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                    className: "p-3.5 text-center whitespace-nowrap",
                                                    children: req.resumeUrl && isValidImageUrl(req.resumeUrl) ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("a", {
                                                        href: req.resumeUrl,
                                                        target: "_blank",
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                selectedReq.aadhaarFront ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            className: "relative group rounded-lg overflow-hidden border border-slate-300 dark:border-slate-700 cursor-pointer shadow-xs",
                                                            children: [
                                                                selectedReq.aadhaarBack ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            className: "relative group rounded-lg overflow-hidden border border-slate-300 dark:border-slate-700 cursor-pointer shadow-xs",
                                                            children: [
                                                                selectedReq.panCard ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
...
_s(AdminRequestsPage, "8HxbPd/3f3BjZT92Krg8UspCNgM=", false, function() {
    return [
...
//# sourceMappingURL=admin_af93cf91._.js.map