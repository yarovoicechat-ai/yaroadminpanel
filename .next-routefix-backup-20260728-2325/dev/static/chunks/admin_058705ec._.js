...
"[project]/admin/app/(dashboard)/operators/request/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function OperatorRequestsPage() {
    ...
    const fetchRequests = (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "OperatorRequestsPage.useCallback[fetchRequests]": async ()=>{
            setLoading(true);
            try {
                ...
                if (res && res.success !== false) {
                    const apiData = items.map({
                        "OperatorRequestsPage.useCallback[fetchRequests].apiData": (item, idx)=>{
                            const d = item.data || {};
                            const ownerRev = item.approvedBy?.find({
                                "OperatorRequestsPage.useCallback[fetchRequests].apiData": (a)=>a.role === 'owner'
                            }["OperatorRequestsPage.useCallback[fetchRequests].apiData"]) || item.reviewByOwner || {};
                            return {
                                id: item._id || '',
                                srNo: idx + 1,
                                ...
                                operatorCode: d.operatorCode || d.specialCode || '',
                    ...
                    }["OperatorRequestsPage.useCallback[fetchRequests].apiData"]);
                    setRequests(apiData);
                } else {
                    setRequests([]);
                }
            } catch (err) {
                console.error('Failed to load operator requests:', err);
    ...
    }["OperatorRequestsPage.useCallback[fetchRequests]"], []);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "OperatorRequestsPage.useEffect": ()=>{
            fetchRequests();
        }
    }["OperatorRequestsPage.useEffect"], [
        fetchRequests
    ...
    const handleRefresh = async ()=>{
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Operator requests updated with latest data');
    };
    // Filter Logic
    const filteredRequests = (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "OperatorRequestsPage.useMemo[filteredRequests]": ()=>{
            return requests.filter({
                "OperatorRequestsPage.useMemo[filteredRequests]": (req)=>{
                    // Search Query Filter
    ...
    const sortedRequests = (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "OperatorRequestsPage.useMemo[sortedRequests]": ()=>{
            return [
                ...filteredRequests
            ].sort({
                "OperatorRequestsPage.useMemo[sortedRequests]": (a, b)=>{
    ...
    const paginatedRequests = (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "OperatorRequestsPage.useMemo[paginatedRequests]": ()=>{
    ...
    const stats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "OperatorRequestsPage.useMemo[stats]": ()=>{
            return {
                total: requests.length,
                active: requests.filter({
                    "OperatorRequestsPage.useMemo[stats]": (r)=>r.status === 'active'
                }["OperatorRequestsPage.useMemo[stats]"]).length,
                pending: requests.filter({
                    "OperatorRequestsPage.useMemo[stats]": (r)=>r.status === 'pending'
                }["OperatorRequestsPage.useMemo[stats]"]).length,
                readyForInterview: requests.filter({
                    "OperatorRequestsPage.useMemo[stats]": (r)=>r.status === 'ready_for_interview'
                }["OperatorRequestsPage.useMemo[stats]"]).length,
                rejected: requests.filter({
                    "OperatorRequestsPage.useMemo[stats]": (r)=>r.status === 'rejected'
                }["OperatorRequestsPage.useMemo[stats]"]).length
            };
        }
    }["OperatorRequestsPage.useMemo[stats]"], [
    ...
    const exportToCSV = ()=>{
        ...
        link.setAttribute('download', `Operator_Requests_${new Date().toISOString().slice(0, 10)}.csv`);
    ...
    const handleOpenConfirm = (req, type)=>{
        ...
        setActionRemarks('');
        setAssignedCode(req.operatorCode || `OPR-${req.district.slice(0, 3).toUpperCase()}-00${req.srNo}`);
    };
    const submitAction = async ()=>{
        ...
        try {
            ...
            const payload = isAccept ? {
                comments: actionRemarks || 'Approved by Admin',
                operatorCode: assignedCode
            } : {
            ...
            if (response.success) {
                if (isAccept && response.data?.generatedCredentials) {
                    // Show the approval credentials dialog
                    setApprovalDialog({
                        isOpen: true,
                ...
                setRequests((prev)=>prev.map((item)=>{
                        if (item.id === req.id) {
                            ...
                            return {
                                ...item,
                                status: newStatus,
                                operatorCode: isAccept ? assignedCode || item.operatorCode : item.operatorCode,
                                reviewByOwner: {
                                    reviewerName: currentUser?.name || 'Admin',
                                    reviewDate: new Date().toLocaleString('en-IN'),
                                    remarks: actionRemarks || (isAccept ? 'Operator Application Approved & Role Granted.' : `Rejected: ${selectedRejectReason}`),
                                ...
                                timeline: [
                                    {
                                        ...
                                        description: actionRemarks || (isAccept ? 'Operator role granted.' : `Reason: ${selectedRejectReason}`),
                ...
                if (!isAccept || !response.data?.generatedCredentials) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(isAccept ? `✅ Operator request for ${req.name} APPROVED!` : `❌ Request for ${req.name} REJECTED.`);
                }
                setConfirmModal({
                    isOpen: false,
                    type: 'accept',
    ...
    const copyCredentials = (req)=>{
        const text = `Meethi Chat Operator Credentials\nUsername: ${req.username}\nPassword: ${req.password || 'Pass@1234'}\nOperator Code: ${req.operatorCode || 'N/A'}`;
        navigator.clipboard.writeText(text);
        __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success('Operator credentials copied to clipboard!');
    };
    // Render Status Badge
                ...
                return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            ...
                            fileName: "[project]/admin/app/(dashboard)/operators/request/page.tsx",
                            lineNumber: 463,
                            columnNumber: 25
                        }, this),
                        "🟢 Active"
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                            ...
                                            children: "Review, verify documents, and approve Operator registration requests before activation."
                                        }, void 0, false, {
                                            fileName: "[project]/admin/app/(dashboard)/operators/request/page.tsx",
                                            lineNumber: 508,
                                            columnNumber: 29
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                                                ...
                                                                children: "No Operator Requests Found"
                                                            }, void 0, false, {
                                                                fileName: "[project]/admin/app/(dashboard)/operators/request/page.tsx",
                                                                lineNumber: 850,
                                                                columnNumber: 49
                                                        ...
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                children: [
                                                                    ...
                                                                    req.operatorCode && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                        className: "text-[10px] text-blue-600 font-mono bg-blue-50 dark:bg-blue-950 px-1.5 py-0.5 rounded",
                                                                        children: req.operatorCode
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/admin/app/(dashboard)/operators/request/page.tsx",
                                                                        lineNumber: 910,
                                                                        columnNumber: 57
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                ...
                                                                children: [
                                                                    req.aadhaarFront ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                                                        ...
                                                                        className: "w-12 h-8 bg-slate-100 dark:bg-slate-800 text-[10px] text-slate-400 flex items-center justify-center font-medium",
                                                                        children: "No Doc"
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/admin/app/(dashboard)/operators/request/page.tsx",
                                                                        lineNumber: 1009,
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                ...
                                                                className: "relative group/img overflow-hidden rounded-lg border border-slate-300 dark:border-slate-700 shadow-xs hover:border-blue-500 transition-all",
                                                                children: [
                                                                    req.aadhaarBack ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                                                        src: req.aadhaarBack,
                                                                        alt: "Aadhaar Back",
                                                                        className: "w-12 h-8 object-cover"
                                                                    }, void 0, false, {
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                ...
                                                                children: [
                                                                    req.panCard ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                                                        src: req.panCard,
                                                                        alt: "PAN Card",
                                                                        className: "w-12 h-8 object-cover"
                                                                    }, void 0, false, {
                                                    ...
                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        ...
                                                        children: [
                                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                                ...
                                                                title: "Accept Request & Activate Operator",
                                                                children: [
                                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$circle$2d$check$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__CheckCircle2$3e$__["CheckCircle2"], {
                                                                        className: "w-3.5 h-3.5"
                                                                    }, void 0, false, {
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        children: "Operator Login Credentials"
                                    }, void 0, false, {
                                        fileName: "[project]/admin/app/(dashboard)/operators/request/page.tsx",
                                        lineNumber: 1279,
                                        columnNumber: 33
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    children: [
                                                                        ...
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                            className: "text-xs text-slate-500 dark:text-slate-400",
                                                                            children: "Secure login credentials assigned to this Operator"
                                                                        }, void 0, false, {
                                                                            fileName: "[project]/admin/app/(dashboard)/operators/request/page.tsx",
                                                                            lineNumber: 1424,
                                                                            columnNumber: 57
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                ...
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                                    ...
                                                                    children: selectedReq.operatorCode || 'N/A'
                                                                }, void 0, false, {
                                                                    fileName: "[project]/admin/app/(dashboard)/operators/request/page.tsx",
                                                                    lineNumber: 1460,
                                                                    columnNumber: 53
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                            ...
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                                    className: "p-2 rounded-lg bg-pink-100 dark:bg-pink-900/50 text-pink-600",
                                                                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$crown$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__Crown$3e$__["Crown"], {
                                                                        className: "w-4 h-4"
                                                                    }, void 0, false, {
                                                                        fileName: "[project]/admin/app/(dashboard)/operators/request/page.tsx",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h3", {
                                                ...
                                                children: confirmModal.type === 'accept' ? 'Approve Operator Role' : 'Reject Application'
                                            }, void 0, false, {
                                                fileName: "[project]/admin/app/(dashboard)/operators/request/page.tsx",
                                                lineNumber: 1696,
                                                columnNumber: 37
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("label", {
                                                ...
                                                children: "Assigned Operator Code"
                                            }, void 0, false, {
                                                fileName: "[project]/admin/app/(dashboard)/operators/request/page.tsx",
                                                lineNumber: 1708,
                                                columnNumber: 41
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("textarea", {
                                                ...
                                                placeholder: "Enter approval notes or instructions for the operator...",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                        ...
                                        className: `px-4 py-2 rounded-xl text-white text-xs font-bold transition-all flex items-center gap-1.5 shadow-md ${confirmModal.type === 'accept' ? 'bg-emerald-600 hover:bg-emerald-700 shadow-emerald-500/20' : 'bg-red-600 hover:bg-red-700 shadow-red-500/20'}`,
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$admin$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                children: confirmModal.type === 'accept' ? 'Approve & Activate' : 'Confirm Reject'
                                            }, void 0, false, {
                                                fileName: "[project]/admin/app/(dashboard)/operators/request/page.tsx",
                                                lineNumber: 1779,
                                                columnNumber: 37
...
_s(OperatorRequestsPage, "AEipYJbNGJF352ldteVD3DRjHOU=", false, function() {
    return [
...
_c = OperatorRequestsPage;
var _c;
__turbopack_context__.k.register(_c, "OperatorRequestsPage");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=admin_058705ec._.js.map