                    ...
                    <div className="pt-3">
                        <label className="flex items-start gap-3 cursor-pointer bg-white/5 p-4 rounded-xl border border-white/10 hover:bg-white/10 transition-all">
                            ...
                            <span className="text-xs text-white/80 leading-relaxed">
                                I commit to providing professional, respectful, and prompt support to MithiChat users. I agree to adhere to standard SLAs and customer service guidelines.
                            </span>
                        </label>
                    </div>
                </div>
