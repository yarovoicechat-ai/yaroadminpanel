...
function AdminFormContent() {
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-[#1e1b4b] via-[#312e81] to-[#4338ca] flex items-center justify-center p-4">
                <div className="max-w-md w-full text-center space-y-6 bg-white/10 backdrop-blur-xl border border-white/20 p-8 rounded-3xl text-white shadow-2xl">
                    ...
                    <p className="text-white/80 text-sm">Your Admin onboarding application has been submitted successfully.</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-[#1e1b4b] via-[#312e81] to-[#4338ca] flex flex-col items-center py-10 px-4">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="flex items-center justify-end gap-4 pt-4">
                        <button
                            type="button"
                            onClick={handleReset}
                            className="bg-white hover:bg-[#312e81] hover:text-white text-slate-800 font-bold px-8 py-2.5 rounded-full text-sm transition-all shadow-md"
                        >
                            Reset All
                        </button>
                        <button
...
export default function AdminFormPage() {
    return (
        <Suspense fallback={<div className="min-h-screen bg-slate-950 text-white flex items-center justify-center">Loading Admin Form...</div>}>
            <AdminFormContent />
        </Suspense>
    );
}
