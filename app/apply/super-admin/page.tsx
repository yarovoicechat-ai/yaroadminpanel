...
function SuperAdminFormContent() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (data.success) {
                setSuccess(true);
                toast.success('Super Admin application submitted successfully!');
            } else {
    ...
    if (success) {
        return (
            <div className="min-h-screen bg-gradient-to-br from-[#4c1d95] via-[#5b21b6] to-[#7c3aed] flex items-center justify-center p-4">
                <div className="max-w-md w-full text-center space-y-6 bg-white/10 backdrop-blur-xl border border-white/20 p-8 rounded-3xl text-white shadow-2xl">
                    ...
                    <p className="text-white/80 text-sm">Your Super Admin onboarding application has been submitted successfully.</p>
                </div>
            </div>
        );
    }
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-[#4c1d95] via-[#5b21b6] to-[#7c3aed] flex flex-col items-center py-10 px-4">
            <div className="max-w-2xl w-full bg-white/10 backdrop-blur-xl border border-white/20 rounded-3xl p-6 md:p-10 text-white shadow-2xl">
                ...
                <div className="mb-8">
                    <h1 className="text-2xl font-extrabold tracking-wide text-white uppercase">
                        SUPER ADMIN FORM - MEETHICHAT
                    </h1>
                    <p className="text-xs font-semibold text-white/70 mt-1">
                        MeethiChat, Super Admin Requirements
                    </p>
                </div>
...
export default function SuperAdminFormPage() {
    return (
        <Suspense fallback={<div className="min-h-screen bg-slate-950 text-white flex items-center justify-center">Loading Super Admin Form...</div>}>
