        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3 shrink-0">
            <Link href="/app-releases">
              <Button className="bg-gradient-to-r from-pink-600 to-purple-600 hover:from-pink-500 hover:to-purple-500 text-white font-bold text-xs px-4 py-5 rounded-2xl shadow-xl flex items-center gap-2">
          ...
          <Card glass className="bg-slate-900/60 border-slate-800 hover:border-pink-500/50 transition-all group">
            ...
            <CardContent className="space-y-4">
              ...
              <Link href="/gifts" className="block">
                <Button className="w-full bg-slate-800 hover:bg-pink-600 text-slate-200 hover:text-white font-bold text-xs rounded-xl flex items-center justify-between transition-all">
          ...
          <Card glass className="bg-slate-900/60 border-slate-800 hover:border-amber-500/50 transition-all group">
            ...
            <CardContent className="space-y-4">
              ...
              <Link href="/referrals" className="block">
                <Button className="w-full bg-slate-800 hover:bg-amber-600 text-slate-200 hover:text-white font-bold text-xs rounded-xl flex items-center justify-between transition-all">
          ...
          <Card glass className="bg-slate-900/60 border-slate-800 hover:border-purple-500/50 transition-all group">
            ...
            <CardContent className="space-y-4">
              ...
              <Link href="/banners" className="block">
                <Button className="w-full bg-slate-800 hover:bg-purple-600 text-slate-200 hover:text-white font-bold text-xs rounded-xl flex items-center justify-between transition-all">
          ...
          <Card glass className="bg-slate-900/60 border-slate-800 hover:border-rose-500/50 transition-all group">
            ...
            <CardContent className="space-y-4">
              ...
              <Link href="/bans/device" className="block">
                <Button className="w-full bg-slate-800 hover:bg-rose-600 text-slate-200 hover:text-white font-bold text-xs rounded-xl flex items-center justify-between transition-all">
          ...
          <Card glass className="bg-slate-900/60 border-slate-800 hover:border-cyan-500/50 transition-all group">
            ...
            <CardContent className="space-y-4">
              ...
              <Link href="/hosts" className="block">
                <Button className="w-full bg-slate-800 hover:bg-cyan-600 text-slate-200 hover:text-white font-bold text-xs rounded-xl flex items-center justify-between transition-all">
          ...
          <Card glass className="bg-slate-900/60 border-slate-800 hover:border-emerald-500/50 transition-all group">
            ...
            <CardContent className="space-y-4">
              ...
              <Link href="/app-releases" className="block">
                <Button className="w-full bg-slate-800 hover:bg-emerald-600 text-slate-200 hover:text-white font-bold text-xs rounded-xl flex items-center justify-between transition-all">
