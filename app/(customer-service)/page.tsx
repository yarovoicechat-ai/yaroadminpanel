...
import { HelpCircle, MessageSquare, Clock, CheckCircle2 } from 'lucide-react';
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-xs text-slate-400 mt-1">
                        In-app helpdesk, live chat user queries, and ticket resolution.
                    </p>
                </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <Card className="bg-slate-900 border-slate-800 text-white rounded-2xl p-4">
                    ...
                    <CardContent className="p-0">
                        <div className="text-2xl font-black text-amber-400">1.8 Mins</div>
                    </CardContent>
                </Card>
