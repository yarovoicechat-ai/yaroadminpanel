        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground mt-1 text-sm">
                        Fill in personal & organizational hierarchy details to submit a Super Admin onboarding request.
                    </p>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <Card className="glass-card border-violet-500/20">
                    <CardHeader>
                        ...
                        <CardDescription className="text-slate-400 text-xs">
                            Automatically generates a secure onboarding URL token for the Super Admin candidate.
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-3">
                        <div className="flex flex-col md:flex-row gap-3 items-stretch md:items-end">
                            <div className="flex-1">
                                <Label className="text-xs text-slate-400 mb-1.5 block">Onboarding Link</Label>
                                <Input
                ...
                <Card className="glass-card">
                    ...
                    <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div className="md:col-span-3">
                            ...
                            <Input
                                placeholder="Street name and location description..."
                ...
                <Card className="glass-card">
                    ...
                    <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <Input
                                placeholder="Professional capabilities"
                                value={form.skills}
                ...
                <Card className="glass-card">
                    <CardHeader>
                        <CardTitle className="text-base text-slate-200 flex items-center gap-2">
                            <Network className="h-4 w-4 text-violet-400" /> Hierarchy
                        </CardTitle>
                        <CardDescription className="text-slate-400 text-xs">
                            Super Admin can only belong under Owner or Operator role parent models.
                        </CardDescription>
                    </CardHeader>
                    <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
