...
import {
    ...
    ChevronRight, Check, AlertCircle, HelpCircle, User, AlertTriangle, Lock, Key, ShieldCheck, Building2, ArrowLeftRight, File, Plus
} from 'lucide-react';
...
const MOCK_AGENCY_REQUESTS: AgencyRequestData[] = [
    {
        id: 'AGY-2024-001',
        srNo: 1,
        ...
        meethiChatId: 'MC-992014',
        username: '@royal_agency',
        gender: 'Male',
        age: 33,
        dob: '1991-04-14',
        maritalStatus: 'Married',
        email: 'siddharth@royalmedia.com',
        mobile: '+91 98220 11223',
        alternateMobile: '+91 98220 11224',
        country: 'India',
        state: 'Maharashtra',
        district: 'Mumbai City',
        city: 'Mumbai',
        pincode: '400050',
        fullAddress: 'Suite 501, Bandra Kurla Complex, Mumbai, Maharashtra',
        registrationDate: '2024-10-24 09:30:00',
        aadhaarNo: 'XXXX-XXXX-4499',
        panNo: 'RMAVR1122K',
        aadhaarFront: createCardSVG('AADHAAR FRONT CARD', '4499 8877 6655', '#2563EB', '#EFF6FF'),
        aadhaarBack: createCardSVG('AADHAAR BACK CARD', 'Address Verified - BKC Mumbai', '#2563EB', '#EFF6FF'),
        panCard: createCardSVG('PERMANENT ACCOUNT NUMBER', 'RMAVR1122K', '#059669', '#ECFDF5'),
        qualification: 'MBA in Marketing & Talent Operations',
        experience: '7 Years Agency & Streamer Management',
        previousCompany: 'Star Media Management',
        skills: ['Host Recruitment', 'Payout Processing', 'Live Stream Oversight'],
        reviewByOperator: {
            reviewerName: 'Anita Sharma (Op-04)',
            reviewDate: '2024-10-24 11:00:00',
            remarks: 'Agency GST & Director Aadhaar documents verified.',
            status: 'Approved'
        },
        reviewBySuperAdmin: {
            reviewerName: 'Vikramaditya Singh (Super Admin)',
            reviewDate: '2024-10-24 13:45:00',
            remarks: 'Approved. Agency account code & portal login created.',
            status: 'Approved'
        },
        password: 'RoyalPass@2024',
        status: 'active',
        agencyCode: 'AGY-MUM-801',
        referralCode: 'REF-OWN-01',
        timeline: [
            { id: '1', title: 'Agency Registration Submitted', description: 'Submitted online by Siddharth Varma (Royal Media)', timestamp: '2024-10-24 09:30:00', actor: 'Applicant', type: 'submission' },
            { id: '2', title: 'Operator Review Completed', description: 'Verified by Anita Sharma (Operator)', timestamp: '2024-10-24 11:00:00', actor: 'Anita Sharma (Operator)', type: 'operator_review' },
            { id: '3', title: 'Super Admin Final Approval', description: 'Approved & activated by Super Admin Vikramaditya Singh', timestamp: '2024-10-24 13:45:00', actor: 'Vikramaditya Singh (Super Admin)', type: 'approval' }
        ]
    },
    {
        id: 'AGY-2024-002',
        ...
        meethiChatId: 'MC-883019',
        username: '@star_talent',
        gender: 'Female',
        age: 28,
        dob: '1996-09-10',
        maritalStatus: 'Single',
        email: 'kavita@startalent.in',
        ...
        city: 'Bengaluru',
        pincode: '560025',
        fullAddress: '14, MG Road, Bengaluru, Karnataka',
        registrationDate: '2024-10-25 11:20:00',
        aadhaarNo: 'XXXX-XXXX-6611',
        panNo: 'KMNPN3344M',
        aadhaarFront: createCardSVG('AADHAAR FRONT CARD', '6611 2233 4455', '#2563EB', '#EFF6FF'),
        aadhaarBack: createCardSVG('AADHAAR BACK CARD', 'Address Verified - MG Road', '#2563EB', '#EFF6FF'),
        panCard: createCardSVG('PERMANENT ACCOUNT NUMBER', 'KMNPN3344M', '#059669', '#ECFDF5'),
        qualification: 'B.Tech in Computer Science',
        experience: '4 Years Digital Agency Management',
        previousCompany: 'Bliss Live Networks',
        skills: ['Host Training', 'Compliance', 'Performance Tracking'],
        reviewByOperator: {
            reviewerName: 'Amit Verma (Op-01)',
            reviewDate: '2024-10-25 14:10:00',
            remarks: 'KYC verified. Scheduled for interview call.',
            status: 'Approved'
        },
        reviewBySuperAdmin: {
            reviewerName: 'Pending Review',
            reviewDate: '—',
            remarks: 'Interview call queued.',
            status: 'Ready For Interview'
        },
        password: 'StarKey#2024',
        status: 'ready_for_interview',
        referralCode: 'DIRECT-PORTAL',
        timeline: [
            { id: '1', title: 'Agency Application Received', description: 'Applied via Meethi Chat Agency Portal', timestamp: '2024-10-25 11:20:00', actor: 'Applicant', type: 'submission' },
            { id: '2', title: 'Operator Review Passed', description: 'Verified by Amit Verma (Operator)', timestamp: '2024-10-25 14:10:00', actor: 'Amit Verma (Operator)', type: 'operator_review' }
        ]
    },
    {
        id: 'AGY-2024-003',
        ...
        meethiChatId: 'MC-771029',
        username: '@apex_live',
        gender: 'Male',
        age: 31,
        dob: '1993-01-20',
        maritalStatus: 'Married',
        email: 'aman@apexlive.com',
        ...
        city: 'New Delhi',
        pincode: '110017',
        fullAddress: 'A-88, South Extension Part 2, New Delhi',
        registrationDate: '2024-10-26 10:45:00',
        aadhaarNo: 'XXXX-XXXX-2288',
        panNo: 'AMDPN9911P',
        aadhaarFront: createCardSVG('AADHAAR FRONT CARD', '2288 3344 5566', '#2563EB', '#EFF6FF'),
        aadhaarBack: createCardSVG('AADHAAR BACK CARD', 'Address Verified - New Delhi', '#2563EB', '#EFF6FF'),
        panCard: createCardSVG('PERMANENT ACCOUNT NUMBER', 'AMDPN9911P', '#059669', '#ECFDF5'),
        qualification: 'Graduate in Event Management',
        experience: '5 Years Host Network Manager',
        previousCompany: 'Vocal Stream India',
        skills: ['Event Organization', 'Host Onboarding'],
        reviewByOperator: {
            reviewerName: 'Pending Review',
            reviewDate: '—',
            remarks: 'Document verification pending in operator queue.',
            status: 'Pending'
        },
        reviewBySuperAdmin: {
            reviewerName: 'Pending Review',
            reviewDate: '—',
            remarks: 'Pending operator approval.',
            status: 'Pending'
        },
        password: 'ApexSecure@12',
        status: 'pending',
        referralCode: 'REF-OP-02',
        timeline: [
            { id: '1', title: 'Agency Application Received', description: 'Referred by Mohan Lal (Operator)', timestamp: '2024-10-26 10:45:00', actor: 'Applicant', type: 'submission' }
        ]
    },
    {
        id: 'AGY-2024-004',
        ...
        username: '@zenith_talent',
        gender: 'Female',
        age: 26,
        dob: '1998-05-30',
        maritalStatus: 'Single',
        email: 'ritu@zenithhub.in',
        ...
        city: 'Lucknow',
        pincode: '226012',
        fullAddress: '45, Aliganj Main Market, Lucknow, Uttar Pradesh',
        registrationDate: '2024-10-26 15:10:00',
        aadhaarNo: 'XXXX-XXXX-9922',
        panNo: 'RTJPN5566L',
        aadhaarFront: createCardSVG('AADHAAR FRONT CARD', '9922 8877 1122', '#2563EB', '#EFF6FF'),
        aadhaarBack: createCardSVG('AADHAAR BACK CARD', 'Blur document uploaded', '#DC2626', '#FEF2F2'),
        panCard: createCardSVG('PERMANENT ACCOUNT NUMBER', 'RTJPN5566L', '#059669', '#ECFDF5'),
        qualification: 'B.A. in Communications',
        experience: '2 Years Live Stream Assistant',
        previousCompany: 'Media Spark',
        skills: ['Host Coordination'],
        reviewByOperator: {
            reviewerName: 'Anita Sharma (Op-04)',
            reviewDate: '2024-10-26 16:40:00',
            remarks: 'Rejected: PAN Card photo illegible & Aadhaar address mismatch.',
            status: 'Rejected'
        },
        reviewBySuperAdmin: {
            reviewerName: 'Priya Sundaram (Super Admin)',
            reviewDate: '2024-10-26 17:30:00',
            remarks: 'Rejection confirmed.',
            status: 'Rejected'
        },
        password: 'ZenithSecret#55',
        status: 'rejected',
        referralCode: 'DIRECT-PORTAL',
        timeline: [
            { id: '1', title: 'Agency Application Received', description: 'Application filed online', timestamp: '2024-10-26 15:10:00', actor: 'Applicant', type: 'submission' },
            { id: '2', title: 'Operator Review Rejected', description: 'Rejected due to blurry document scan', timestamp: '2024-10-26 16:40:00', actor: 'Anita Sharma (Operator)', type: 'operator_review' },
            { id: '3', title: 'Super Admin Confirmed Rejection', description: 'Rejection confirmed', timestamp: '2024-10-26 17:30:00', actor: 'Priya Sundaram (Super Admin)', type: 'rejection' }
        ]
    },
    {
        id: 'AGY-2024-005',
        ...
        meethiChatId: 'MC-550192',
        username: '@galaxy_host',
        gender: 'Male',
        age: 34,
        dob: '1990-08-11',
        maritalStatus: 'Married',
        email: 'gaurav@galaxyhost.com',
        mobile: '+91 93221 44332',
        country: 'India',
        state: 'Maharashtra',
        district: 'Pune',
        city: 'Pune',
        pincode: '411014',
        fullAddress: 'Flat 102, Viman Nagar, Pune, Maharashtra',
        registrationDate: '2024-10-27 08:40:00',
        aadhaarNo: 'XXXX-XXXX-1144',
        panNo: 'GRKPN7788Q',
        aadhaarFront: createCardSVG('AADHAAR FRONT CARD', '1144 5566 9900', '#2563EB', '#EFF6FF'),
        aadhaarBack: createCardSVG('AADHAAR BACK CARD', 'Address Verified - Viman Nagar', '#2563EB', '#EFF6FF'),
        panCard: createCardSVG('PERMANENT ACCOUNT NUMBER', 'GRKPN7788Q', '#059669', '#ECFDF5'),
        qualification: 'B.Com & Financial Risk Certificate',
        experience: '6 Years Regional Agency Head',
        previousCompany: 'Galaxy Entertainment Network',
        skills: ['Host Recruitment', 'Commission Auditing', 'Conflict Management'],
        reviewByOperator: {
            reviewerName: 'Suresh Kumar (Op-03)',
            reviewDate: '2024-10-27 10:15:00',
            remarks: 'Passed preliminary background check and document verification.',
            status: 'Approved'
        },
        reviewBySuperAdmin: {
            reviewerName: 'Pending Review',
            reviewDate: '—',
            remarks: 'Scheduled for interview call on 28th Oct.',
            status: 'Ready For Interview'
        },
        password: 'GalaxyKey@9988',
        status: 'ready_for_interview',
        referralCode: 'REF-OP-03',
        timeline: [
            { id: '1', title: 'Agency Registration Received', description: 'Referred by Operator Suresh Kumar', timestamp: '2024-10-27 08:40:00', actor: 'Applicant', type: 'submission' },
            { id: '2', title: 'Operator Review Approved', description: 'Approved by Suresh Kumar', timestamp: '2024-10-27 10:15:00', actor: 'Suresh Kumar (Operator)', type: 'operator_review' }
        ]
    }
];
...
export default function AgencyRequestsPage() {
    ...
    // Sorting & Pagination
    const [sortColumn, setSortColumn] = useState<keyof AgencyRequestData>('srNo');
    const [sortDirection, setSortDirection] = useState<'asc' | 'desc'>('asc');
    const [page, setPage] = useState(1);
    const [pageSize, setPageSize] = useState(10);

    // Modals & Drawers
    const [selectedReq, setSelectedReq] = useState<AgencyRequestData | null>(null);
    const [detailTab, setDetailTab] = useState<'profile' | 'identity' | 'credentials' | 'review' | 'timeline'>('profile');
    ...
    const [confirmModal, setConfirmModal] = useState<{
        isOpen: boolean;
        type: 'accept' | 'reject';
        request: AgencyRequestData | null;
    }>({
        isOpen: false,
        type: 'accept',
        request: null
    ...
    const fetchRequests = useCallback(async () => {
        setLoading(true);
        try {
            const res = await apiClient.get('/api/ems/requests', { requestType: 'Agency Request' });
            ...
            if (res && res.success !== false) {
                const apiData: AgencyRequestData[] = items.map((item: any, idx: number) => {
                    const d = item.data || {};
                    const opRev = item.approvedBy?.find((a: any) => a.role === 'operator') || item.reviewByOperator || {};
                    const saRev = item.approvedBy?.find((a: any) => a.role === 'superAdmin' || a.role === 'super_admin' || a.role === 'owner') || item.reviewBySuperAdmin || {};
                    ...
                    return {
                        ...
                        timeline: item.timeline || [
                            { id: '1', title: 'Agency Application Received', description: 'Application filed successfully', timestamp: item.createdAt || new Date().toISOString(), actor: 'System', type: 'submission' }
                        ]
                    };
                });
                setRequests(apiData);
    ...
    const handleRefresh = async () => {
        ...
        toast.success('Agency requests updated with latest data');
    };
    ...
    // Sort Toggle Handler
    const handleSort = (col: keyof AgencyRequestData) => {
        if (sortColumn === col) {
    ...
    const handleOpenConfirm = (req: AgencyRequestData, type: 'accept' | 'reject') => {
        setConfirmModal({
            isOpen: true,
            type,
            request: req
    ...
    const submitTransfer = async () => {
        ...
        try {
            ...
            toast.success(`🔀 Request for ${req.agencyName || req.name} transferred to ${targetRecipient}!`);
    ...
    const submitAction = async () => {
        ...
        try {
            ...
            const payload = isAccept
                ? { comments: actionRemarks || 'Approved', agencyCode: assignedCode }
            ...
            if (response.success) {
                ...
                if (!isAccept || !response.data?.generatedCredentials) {
                    toast.success(isAccept ? `✅ Agency request for ${req.agencyName || req.name} APPROVED!` : `❌ Request for ${req.agencyName || req.name} REJECTED.`);
                }
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-slate-500 dark:text-slate-400 mt-0.5">
                                Review, verify identity documents, and approve Agency registration requests before activation.
                            </p>
                        </div>
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                <th className="p-3.5 whitespace-nowrap">
                                    <button onClick={() => handleSort('name')} className="flex items-center gap-1 hover:text-blue-600">
                                        Name / Agency <ArrowUpDown className="w-3 h-3 text-slate-400" />
                                    </button>
                                </th>
                                ...
                                <tr>
                                    <td colSpan={21} className="p-12 text-center">
                                        <div className="max-w-md mx-auto space-y-4">
                                            ...
                                            <div>
                                                <h3 className="text-base font-bold text-slate-800 dark:text-white">No Agency Requests Found</h3>
                        ...
                        >
                            ...
                            <div className="p-5 border-b border-slate-200 dark:border-slate-800 bg-slate-50/80 dark:bg-slate-850 flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        <div className="flex items-center gap-2">
                                            <h2 className="text-lg font-bold text-slate-900 dark:text-white">{selectedReq.agencyName || selectedReq.name}</h2>
                                            {renderStatusBadge(selectedReq.status)}
                                        </div>
                                        <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
                                            Manager: <span className="font-semibold text-slate-800 dark:text-slate-200">{selectedReq.name}</span> • ID: <span className="font-mono font-semibold text-slate-700 dark:text-slate-200">{selectedReq.meethiChatId}</span>
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="flex-1 overflow-y-auto p-6 space-y-6">
                                    ...
                                    <div className="space-y-6 text-xs">
                                        ...
                                        <div className="bg-slate-50 dark:bg-slate-800/40 p-4 rounded-xl border border-slate-200/80 dark:border-slate-800 space-y-3">
                                            ...
                                            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                                                <div>
                                                    <p className="text-slate-400">Manager Full Name</p>
                                                    <p className="font-semibold text-slate-800 dark:text-slate-100">{selectedReq.name}</p>
                                                </div>
                                                <div>
                                                    <p className="text-slate-400">Agency Name</p>
                                                    <p className="font-semibold text-slate-800 dark:text-slate-100">{selectedReq.agencyName || 'N/A'}</p>
                                                </div>
                                                <div>
                                                ...
                                                <div>
                                                    <p className="text-slate-400">Age / DOB</p>
                                        ...
                                        <div className="bg-slate-50 dark:bg-slate-800/40 p-4 rounded-xl border border-slate-200/80 dark:border-slate-800 space-y-3">
                                            ...
                                            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                                                ...
                                                <div className="col-span-2 sm:col-span-3">
                                                    <p className="text-slate-400">Full Residential / Office Address</p>
                                        ...
                                        <div className="bg-slate-50 dark:bg-slate-800/40 p-4 rounded-xl border border-slate-200/80 dark:border-slate-800 space-y-3">
                                            ...
                                            <div className="grid grid-cols-2 gap-4">
                                                ...
                                                <div>
                                                    <p className="text-slate-400">Invited By / Referrer</p>
                                ...
                                {detailTab === 'credentials' && (
                                    <div className="space-y-6 text-xs">
                                        <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-slate-800 dark:to-slate-850 p-6 rounded-xl border border-blue-200/80 dark:border-slate-700 space-y-4">
                                            <div className="flex items-center justify-between">
                                                <div className="flex items-center gap-2.5">
                                                    ...
                                                    <div>
                                                        <h4 className="text-sm font-bold text-slate-900 dark:text-white">Agency Login Credentials</h4>
                                                        <p className="text-xs text-slate-500 dark:text-slate-400">Secure credentials generated for Agency portal login</p>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2">
                                                ...
                                                <div className="bg-white dark:bg-slate-900 p-3.5 rounded-xl border border-slate-200 dark:border-slate-800">
                                                    ...
                                                    <p className="font-mono font-bold text-blue-600 dark:text-blue-400">{selectedReq.agencyCode || 'N/A'}</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="text-base font-bold text-slate-900 dark:text-white">
                                        {confirmModal.type === 'accept' ? 'Approve Agency Activation' : 'Reject Application'}
                                    </h3>
                                    <p className="text-xs text-slate-500 dark:text-slate-400">
                                        Agency: <span className="font-semibold text-slate-800 dark:text-slate-200">{confirmModal.request.agencyName || confirmModal.request.name}</span> ({confirmModal.request.meethiChatId})
                                    </p>
                                </div>
                            </div>
                                ...
                                <div className="space-y-3 text-xs">
                                    <div>
                                        ...
                                        >
                                            ...
                                            <option value="Ineligible Experience">Insufficient Agency Operations History</option>
                    ...
                    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/70 backdrop-blur-xs p-4">
                        ...
                        >
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="text-base font-bold text-slate-900 dark:text-white">
                                        Transfer Agency Request
                                    </h3>
                                    <p className="text-xs text-slate-500 dark:text-slate-400">
                                        Reassign <span className="font-semibold text-slate-800 dark:text-slate-200">{transferModal.request.agencyName || transferModal.request.name}</span> ({transferModal.request.meethiChatId}) to another reviewer.
                                    </p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-3 text-xs">
                                <div>
                                    ...
                                    >
                                        ...
                                        <option value="Star Talent Agency">Star Talent Agency Network</option>
                                        <option value="Apex Live Media Network">Apex Live Media Network</option>
                                    </select>
                                </div>
                                <div>
                                    <label className="block font-semibold text-slate-700 dark:text-slate-300 mb-1">
                        ...
                        >
                            <div className="flex items-center justify-between border-b border-slate-800 pb-4 mb-4">
                                <div className="flex items-center gap-2">
                                    ...
                                    <h2 className="text-xl font-bold text-white">Submit New Agency Request</h2>
                                </div>
                                <button
