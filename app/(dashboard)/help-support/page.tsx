            ...
            {selectedTicket && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
                    <div className="bg-slate-900 border border-slate-800 rounded-xl p-6 w-full max-w-md shadow-2xl space-y-4">
                        ...
                        <div className="bg-slate-950 p-3 rounded-lg border border-slate-800 max-h-28 overflow-y-auto">
                            <p className="text-xs text-slate-400 font-semibold mb-1">User Query:</p>
                            <p className="text-xs text-slate-300 italic font-medium font-sans">"{selectedTicket.message}"</p>
                        </div>
