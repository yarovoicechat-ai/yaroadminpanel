...
// Sample SVG Image Generator for realistic document placeholders
...
const MOCK_HOST_REQUESTS: HostRequestData[] = [
    {
        id: 'HST-2024-001',
        srNo: 1,
        ...
        alternateMobile: '+91 98112 33446',
        country: 'India',
        state: 'Maharashtra',
        district: 'Mumbai City',
        city: 'Mumbai',
        pincode: '400050',
        fullAddress: 'Flat 402, Bandra West, Mumbai, Maharashtra',
        registrationDate: '2024-10-24 10:15:00',
        aadhaarNo: 'XXXX-XXXX-8811',
        panNo: 'ALNPS7788K',
        aadhaarFront: createCardSVG('AADHAAR FRONT CARD', '8811 2233 4455', '#2563EB', '#EFF6FF'),
        aadhaarBack: createCardSVG('AADHAAR BACK CARD', 'Address Verified - Bandra Mumbai', '#2563EB', '#EFF6FF'),
        panCard: createCardSVG('PERMANENT ACCOUNT NUMBER', 'ALNPS7788K', '#059669', '#ECFDF5'),
        voiceAudioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-1.mp3',
        voiceDuration: '0:28',
        voiceWaveform: [30, 45, 80, 60, 95, 40, 70, 85, 50, 90, 65, 40, 75, 90, 55, 35, 70, 80, 60, 40],
        qualification: 'B.A. in Performing Arts',
        experience: '2 Years Live Streamer',
        skills: ['Singing', 'Bilingual Host', 'Interactive Games'],
        status: 'active',
        hostCode: 'HST-MUM-101',
        agencyName: 'Royal Media Agency',
        timeline: [
            { id: '1', title: 'Host Registration Submitted', description: 'Application & Voice sample submitted by Alina Sen', timestamp: '2024-10-24 10:15:00', actor: 'Applicant', type: 'submission' },
            { id: '2', title: 'Under Review', description: 'Audition voice sample & KYC verified by Agency', timestamp: '2024-10-24 11:30:00', actor: 'Royal Media Agency', type: 'under_review' },
            { id: '3', title: 'Host Activated', description: 'Host account activated & streamer portal unlocked', timestamp: '2024-10-24 14:00:00', actor: 'Super Admin Team', type: 'approval' }
        ]
    },
    {
        id: 'HST-2024-002',
        ...
        city: 'Bengaluru',
        pincode: '560025',
        fullAddress: '12, Koramangala 4th Block, Bengaluru, Karnataka',
        registrationDate: '2024-10-25 11:45:00',
        aadhaarNo: 'XXXX-XXXX-4422',
        panNo: 'JNKPK3344M',
        aadhaarFront: createCardSVG('AADHAAR FRONT CARD', '4422 5566 7788', '#2563EB', '#EFF6FF'),
        aadhaarBack: createCardSVG('AADHAAR BACK CARD', 'Address Verified - Koramangala Bengaluru', '#2563EB', '#EFF6FF'),
        panCard: createCardSVG('PERMANENT ACCOUNT NUMBER', 'JNKPK3344M', '#059669', '#ECFDF5'),
        voiceAudioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-2.mp3',
        voiceDuration: '0:35',
        voiceWaveform: [40, 60, 30, 85, 70, 95, 60, 40, 80, 75, 90, 50, 65, 80, 45, 30, 85, 95, 70, 50],
        qualification: 'B.Com in Finance',
        experience: '1 Year Music Streamer',
        skills: ['Guitar Performance', 'Talk Show Hosting'],
        status: 'inactive',
        hostCode: 'HST-BLR-102',
        agencyName: 'Star Talent Agency',
        timeline: [
            { id: '1', title: 'Host Registration Submitted', description: 'Application filed via Star Talent Agency', timestamp: '2024-10-25 11:45:00', actor: 'Applicant', type: 'submission' },
            { id: '2', title: 'Under Review', description: 'Awaiting final audition confirmation', timestamp: '2024-10-25 14:10:00', actor: 'Star Talent Agency', type: 'under_review' }
        ]
    },
    {
        id: 'HST-2024-003',
        ...
        city: 'New Delhi',
        pincode: '110016',
        fullAddress: 'H-33, Hauz Khas Enclave, New Delhi',
        registrationDate: '2024-10-26 09:30:00',
        aadhaarNo: 'XXXX-XXXX-6677',
        panNo: 'PRYPN9900L',
        aadhaarFront: createCardSVG('AADHAAR FRONT CARD', '6677 8899 0011', '#2563EB', '#EFF6FF'),
        aadhaarBack: createCardSVG('AADHAAR BACK CARD', 'Address Verified - Hauz Khas', '#2563EB', '#EFF6FF'),
        panCard: createCardSVG('PERMANENT ACCOUNT NUMBER', 'PRYPN9900L', '#059669', '#ECFDF5'),
        voiceAudioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-3.mp3',
        voiceDuration: '0:22',
        voiceWaveform: [50, 70, 90, 40, 60, 80, 95, 30, 65, 85, 75, 55, 90, 60, 45, 75, 85, 65, 50, 30],
        qualification: 'Bachelor of Design',
        experience: 'New Streamer',
        skills: ['Fashion Talk', 'Storytelling'],
        status: 'active',
        hostCode: 'HST-DEL-103',
        agencyName: 'Direct Meethi Host Network',
        timeline: [
            { id: '1', title: 'Host Registration Submitted', description: 'Direct application with intro voice recording', timestamp: '2024-10-26 09:30:00', actor: 'Applicant', type: 'submission' },
            { id: '2', title: 'Host Activated', description: 'Voice sample verified & Host account activated', timestamp: '2024-10-26 12:00:00', actor: 'Admin Team', type: 'approval' }
        ]
    },
    {
        id: 'HST-2024-004',
        ...
        city: 'Pune',
        pincode: '411014',
        fullAddress: '15, Kalyani Nagar, Pune, Maharashtra',
        registrationDate: '2024-10-26 15:20:00',
        aadhaarNo: 'XXXX-XXXX-3344',
        panNo: 'ASYPN1122Q',
        aadhaarFront: createCardSVG('AADHAAR FRONT CARD', '3344 5566 7788', '#2563EB', '#EFF6FF'),
        aadhaarBack: createCardSVG('AADHAAR BACK CARD', 'Address Verified - Kalyani Nagar Pune', '#2563EB', '#EFF6FF'),
        panCard: createCardSVG('PERMANENT ACCOUNT NUMBER', 'ASYPN1122Q', '#059669', '#ECFDF5'),
        voiceAudioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-4.mp3',
        voiceDuration: '0:31',
        voiceWaveform: [35, 55, 75, 95, 60, 45, 80, 90, 65, 40, 85, 70, 50, 95, 60, 40, 75, 85, 65, 45],
        qualification: 'B.A. English Literature',
        experience: '3 Years Live Radio Host',
        skills: ['Vocal Performance', 'Comedy SKits'],
        status: 'inactive',
        hostCode: 'HST-PUN-104',
        agencyName: 'Galaxy Host Management',
        timeline: [
            { id: '1', title: 'Host Registration Submitted', description: 'Application filed online', timestamp: '2024-10-26 15:20:00', actor: 'Applicant', type: 'submission' }
        ]
    },
    {
        id: 'HST-2024-005',
        ...
        city: 'Lucknow',
        pincode: '226010',
        fullAddress: '88, Gomti Nagar, Lucknow, Uttar Pradesh',
        registrationDate: '2024-10-27 08:30:00',
        aadhaarNo: 'XXXX-XXXX-9955',
        panNo: 'RYVPN3344P',
        aadhaarFront: createCardSVG('AADHAAR FRONT CARD', '9955 1122 3344', '#2563EB', '#EFF6FF'),
        aadhaarBack: createCardSVG('AADHAAR BACK CARD', 'Address Verified - Gomti Nagar', '#2563EB', '#EFF6FF'),
        panCard: createCardSVG('PERMANENT ACCOUNT NUMBER', 'RYVPN3344P', '#059669', '#ECFDF5'),
        voiceAudioUrl: 'https://www.soundhelix.com/examples/mp3/SoundHelix-Song-5.mp3',
        voiceDuration: '0:26',
        voiceWaveform: [45, 65, 85, 95, 70, 50, 80, 60, 90, 75, 40, 85, 95, 60, 45, 70, 80, 65, 50, 35],
        qualification: 'B.Sc Journalism',
        experience: '1 Year Event Host',
        skills: ['Live Q&A', 'Music Hosting'],
        status: 'active',
        hostCode: 'HST-LKO-105',
        agencyName: 'Apex Live Media',
        timeline: [
            { id: '1', title: 'Host Registration Submitted', description: 'Application filed online', timestamp: '2024-10-27 08:30:00', actor: 'Applicant', type: 'submission' },
            { id: '2', title: 'Host Activated', description: 'Approved by Apex Live Media & Admin', timestamp: '2024-10-27 10:00:00', actor: 'Admin Team', type: 'approval' }
        ]
    }
];
